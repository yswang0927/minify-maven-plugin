...
public abstract class MojoSupport extends AbstractMojo {
	...
	/**
	 * Javascript source directory. (result will be put to outputDirectory). This
	 * allow project with "src/main/js" structure.
	 *
	...
	/**
	 * Force to use defaultIncludes (ignore srcIncludes) to avoid processing
	 * resources/includes from other type than *.css or *.js
	 * 
